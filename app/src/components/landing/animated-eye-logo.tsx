...
const eyeFrames = [
  ...
  <svg key="e6" viewBox="0 0 34 34" fill="none" xmlns="http://www.w3.org/2000/svg">
    <circle cx="16.77" cy="16.77" r="16.77" className="fill-black dark:fill-white" />
    <ellipse cx="17" cy="17" rx="4" ry="10.5" className="fill-white dark:fill-black" />
  </svg>,
]
